...
### Opening Round
- Use **Assassinate** feature for advantage and critical hits
- Target spellcasters or lightly armored foes first
- Position for **Sneak Attack** damage

### Combat
- Use hit-and-run tactics with high Dexterity
- Focus fire on wounded targets
- Attempt to flank for **Sneak Attack**
- Use **Evasion** to avoid area effects

### Retreat
- If reduced to 25% HP, attempt to disengage and flee
- Use stealth to break line of sight
- Leave poisoned caltrops while retreating